...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide">GABRIEL ALMEIDA</a>
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="home_eng.html" class="w3-bar-item w3-button"><i class="fa fa-globe"></i> <u>PT</u>/ENG</a>
    </div>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-right w3-hide-medium w3-hide-large" style="display:none; right:0" id="mySidebar">
  ...
  <a href="home_eng.html" onclick="w3_close()" class="w3-bar-item w3-button"></i> <u>PT</u>/ENG</a>
</nav>
...
<div class="w3-container" style="padding:128px 16px" id="about">  
  <div class="w3-center">
    <img src="resources/profile.png" style="border-radius: 50%; width: 200px; padding-bottom: 20px;">
    <h3 class="w3-center">SOBRE MIM</h3>
    <p class="w3-center w3-large">Estudante de Engenharia Informática e de Computadores no Instituto Superior Técnico. </p>
    ...
    Então, decidi-me aventurar e ir estudar em Lisboa, devido ao prestigio do IST, indo já no segundo ano da Licenciatura. Sempre me fascinei e tive interesse em Inteligência Artificial, sendo por isso que estou a ponderar
...
num estágio de verão para adquirir experiência.</p>
  </div>
</div>
...
<div class="w3-container w3-light-grey" style="padding:64px 16px">
  ...
  <p class="w3-center w3-large">Atualmente estou a aprender Japonês por conta própria, devido ao meu interesse no país e na cultura Japonesa</p>
  <p class="w3-center w3-large">はじめまして、お元気ですか？
    <br>私はガブリエルで、十九さいで、ポルトガル人です。コインブラとリスボンにすんでいます。弟と妹が一人います。私の大学はISTで、大学二年生です。
    <br>よろしくね！</p>
</div>
...
<div class="w3-row-padding">
    <div class="w3-col m6">
      ...
      <p>De momento estou a aprender HTML, CSS e JavaScript, na cadeira de IPM (Interação Pessoa Máquina) que com 
        esse conhecimento permitiu-me realizar este site e a dar-me mais conhecimento sobre UI (User Interface) e 
        de como fazê-lo.
      </p>
    ...
    <div class="w3-col m6">
      ...
      <p class="w3-wide"><i class="fa fa-desktop w3-margin-right"></i>Python</p>
      <div class="w3-grey">
      ...
      <p class="w3-wide"><i class="fa fa-desktop w3-margin-right"></i>Prolog</p>
      <div class="w3-grey">
        <div class="w3-container w3-dark-grey w3-center" style="width:45%">45%</div>
      </div>
      <p class="w3-wide"><i class="fa fa-desktop w3-margin-right"></i>Assembly</p>
      <div class="w3-grey">
...
<div class="w3-container w3-dark-grey w3-center" style="padding:128px 16px" id="work">
  <h3>PORTFOLIO</h3>
  <p class="w3-large">O que eu fiz até agora</p>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    ...
    <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> mail pessoal: <a href="mailto:galmeida9@gmail.com">galmeida9@gmail.com</a></p>
    <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> mail da universidade: <a href="mailto:>gabriel.almeida@tecnico.ulisboa.pt">gabriel.almeida@tecnico.ulisboa.pt</a></p>
    <p><i class="fa fa-facebook fa-fw w3-xxlarge w3-margin-right"> </i> Redes sociais encontram-se em baixo e no slideshow</p>
    <br>
  </div>
</div>
...
<footer class="w3-center w3-black w3-padding-64">
  <a href="#home" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Para cima</a>
